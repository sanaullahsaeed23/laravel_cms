<?php
use App\Http\Controllers\Backend\NoticeBoard\NoticeBoardController;
...
use App\Http\Controllers\Backend\Employee;
...
Route::middleware([
    ...
    return view('admin.index', ['totalTeacher' => $totalTeacher, 'totalStudent' => $totalStudent]);
    })->name('dashboard');
});
...
// Student and Teacher NoticeBoard Routes 
Route::prefix('notice')->group(function(){

    Route::get('/view', [NoticeBoardController::class, 'NoticeView'])->name('notice.view');
    Route::get('/add', [NoticeBoardController::class, 'NoticeAdd'])->name('notice.add');
    Route::get('/search', [NoticeBoardController::class, 'search'])->name('notice_board.search');

    
    // Route::get('/edit', [ProfileController::class, 'ProfileEdit'])->name('profile.edit');
    
Route::post('store', [NoticeBoardController::class, 'NoticeStore'])->name('notice.store');
Route::get('store', [NoticeBoardController::class, 'NoticeView'])->name('notice.view');
...
Route::prefix('teachers')->group(function(){
    ...
    Route::get('reg/teacher/view', [TeacherController::class, 'TeacherView'])->name('teacher.registration.view');
    
    Route::get('reg/teacher/add', [TeacherController::class, 'EmployeeAdd'])->name('teacher.registration.add');
    
    Route::post('reg/teacher/store', [TeacherController::class, 'EmployeeStore'])->name('teacher.employee.registration');
     
    Route::get('reg/teacher/edit/{id}', [TeacherController::class, 'EmployeeEdit'])->name('teacher.registration.edit');
    
    Route::post('reg/employee/update/{id}', [TeacherController::class, 'EmployeeUpdate'])->name('update.employee.registration');
    
    Route::get('reg/teacher/details/{id}', [TeacherControllers::class, 'EmployeeDetails'])->name('teacher.registration.details');
    // Route::get('reg/teacher/details/{id}', 'app/Http/Controllers/Backend/Teacher/TeacherController@EmployeeDetails')->name('teacher.registration.details');
    ...
    Route::post('monthly/salary/store', [MonthlySalaryController::class, 'AccountSalaryGetEmployee'])->name('monthly.salary.store');
...
Route::get('reg/employee/add', [TeacherController::class, 'EmployeeAdd'])->name('employee.registration.add');

Route::post('reg/employee/store', [TeacherController::class, 'EmployeeStore'])->name('store.employee.registration');
 
Route::get('reg/employee/edit/{id}', [TeacherController::class, 'EmployeeEdit'])->name('employee.registration.edit');

Route::post('reg/employee/update/{id}', [TeacherController::class, 'EmployeeUpdate'])->name('update.employee.registration');

Route::get('reg/employee/details/{id}', [TeacherController::class, 'EmployeeDetails'])->name('employee.registration.details');

// Employee Salary All Routes 
Route::get('salary/teacher/view', [EmployeeSalaryController::class, 'SalaryView'])->name('teacher.salary.view');

Route::get('salary/teacher/increment/{id}', [EmployeeSalaryController::class, 'SalaryIncrement'])->name('teacher.salary.increment');

Route::post('salary/teacher/store/{id}', [EmployeeSalaryController::class, 'SalaryStore'])->name('update.increment.store');

Route::get('salary/teacher/details/{id}', [EmployeeSalaryController::class, 'SalaryDetails'])->name('teacher.salary.details');


// Employee Leave All Routes 
Route::get('leave/teacher/view', [EmployeeLeaveController::class, 'LeaveView'])->name('teacher.leave.view');

Route::get('leave/teacher/add', [EmployeeLeaveController::class, 'LeaveAdd'])->name('teacher.leave.add');
