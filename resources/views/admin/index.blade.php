...
@section('admin')
		...
		<section class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                        <i class="fa fa-graduate fa-3x text-primary"></i>
  ...
  <!-- /.content-wrapper -->
	...
	<script src="{{ asset('backend/js/pages/widget-chartist.js') }}"></script>
  ...
  new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        label: '# of Votes',
		data: [{{ $totalTeacher }}, {{ $totalStudent }}, 3, 5, 2, 3],
        borderWidth: 1
      }]
    },
    options: {
