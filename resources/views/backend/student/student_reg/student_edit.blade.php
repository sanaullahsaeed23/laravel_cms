...
<section class="content">
	 ...
	 <form method="post" action="{{ route('update.student.registration',$editData->rollNumber) }}" enctype="multipart/form-data">
	 	@csrf
...
<div class="col-md-4">
 ...
 <option value="Christan"{{ ($editData['religion'] == 'Christan')? 'selected':'' }}>Christan</option>
	...
	<div class="col-md-4">
	 ...
	 <input type="number" name="discount" class="form-control" required="" value="{{ $editData['discount_id'] }}" > 
...
<div class="col-md-4">
 		...
 		<div class="form-group">
		<div class="controls">
	<img id="showImage" src="{{ (!empty($editData['profile']))? url('upload/student_images/'.$editData['profile']):url('upload/no_image.jpg') }}" style="width: 100px; width: 100px; border: 1px solid #000000;"> 
