								...
								<table id="example1" class="table table-bordered table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<img src="{{ (!empty($value['profile']))? url('upload/student_images/'.$value['profile']):url('upload/no_image.jpg') }}" style="width: 60px; width: 60px;">
											</td>
											<td> {{ $value->code }}</td>
											<td>
												<a title="Edit" href="{{ route('student.registration.edit',$value->rollNumber) }}" class="btn btn-info"> <i class="fa fa-edit"></i> </a>

												<a title="Promotion" href="{{ route('student.registration.promotion',$value->rollNumber) }}" class="btn btn-primary"><i class="fa fa-check"></i></a>

												<a target="_blank" title="Details" href="{{ route('student.registration.details',$value->rollNumber) }}" class="btn btn-danger"><i class="fa fa-eye"></i></a>
