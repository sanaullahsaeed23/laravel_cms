...
<div class="col-md-3">
		...
		<h5>RollNumber<span class="text-danger"> </span></h5>
		<div class="controls">
	<input type="text" name="rollNumber" id="rollNumber" required class="form-control" placeholder="Enter Roll Number">
  ...
  $(document).on('click','#search',function(){
    ...
    var date = $('#date').val();   
     $.ajax({
      ...
      type: "get",
      data: {'rollNumber':rollNumber,'class_id':class_id,'fee_category_id':fee_category_id,'date':date},
      beforeSend: function() {       
      },
